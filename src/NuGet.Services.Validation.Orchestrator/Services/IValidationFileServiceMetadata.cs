...
{
    /// <summary>
    /// All the metadata needed for file manipulation in validation pipeline. Save, delete, copy.
    /// </summary>
    public interface IValidationFileServiceMetadata
    {
        /// <summary>
        /// This is the public folder name where files will be copied. For example <see cref="CoreConstants.PackagesFolderName"/>
        /// </summary>
        string FilePublicFolderName { get; }
