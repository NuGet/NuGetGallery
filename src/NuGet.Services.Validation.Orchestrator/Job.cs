...
namespace NuGet.Services.Validation.Orchestrator
{
    public class Job : JsonConfigurationJob
    {
        ...
        private const string LocalValidationConfigurationSectionName = "LocalValidation";
        ...
        protected override void ConfigureJobServices(IServiceCollection services, IConfigurationRoot configurationRoot)
        {
            ...
            services.Configure<LocalValidationConfiguration>(configurationRoot.GetSection(LocalValidationConfigurationSectionName));
            ...
            services.AddTransient<LocalValidator>();
