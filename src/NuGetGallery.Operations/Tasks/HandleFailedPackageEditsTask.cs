            ...
            { 
               ...
               edit.Package.PackageRegistration.Id);
                SendMailTask mailTask = new SendMailTask
                {
                    ...
                    MailContent =
                        $"<b><i>Package:</i></b>  {edit.Package.PackageRegistration.Id} </br> <b>Version:</b>  {edit.Package.NormalizedVersion} </br> <b>TimeStamp:</b>  {edit.Timestamp} </br> <b>LastError:</b>  {edit.LastError} </br> <i>Message sent from NuGet Gallery</i> "
                };
                try
                {
                    mailTask.Execute();
