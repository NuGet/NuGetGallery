...
namespace Ng
{
    class Lightning
    {
        ...
        private static void PrintUsage()
        {
            ...
            Console.WriteLine("  ng lightning -command prepare -outputFolder <output-folder> -catalogIndex <catalog-index-url> -contentBaseAddress <content-address> -templateFile <template-file> -batchSize 2000 -storageContainer <connection-string> -container <container> -storageBaseAddress <storage-base-address> [-verbose true|false]");
            Console.WriteLine();
            ...
            Console.WriteLine("  ng lightning -command strike -indexFile <index-file> -cursorFile <cursor-file> -contentBaseAddress <content-address> -storageAccount <connection-string> -storageContainer <container> -storageBaseAddress <base-address> [-verbose true|false]");
            Console.WriteLine();
