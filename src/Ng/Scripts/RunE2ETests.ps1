...
Write-Host "Started build $BuildId to run end-to-end tests:  https://nuget.visualstudio.com/NuGetBuild/_build/index?buildId=$BuildId"
...
Write-Host "******************************************"
$BuildUri = $Build.uri
Write-Host "For more details check out:"  "https://nuget.visualstudio.com/NuGetBuild/_build/index?buildId=$BuildId"
