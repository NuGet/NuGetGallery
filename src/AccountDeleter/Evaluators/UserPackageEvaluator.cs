...
namespace NuGetGallery.AccountDeleter
{
    public class UserPackageEvaluator : IUserEvaluator
    {
        ...
        private readonly ITelemetryService _telemtryService;
        private readonly ILogger<UserPackageEvaluator> _logger;

        public UserPackageEvaluator(IPackageService packageService, ITelemetryService telemetryService, ILogger<UserPackageEvaluator> logger)
        {
