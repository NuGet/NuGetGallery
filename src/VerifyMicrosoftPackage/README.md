...
**Note:** this script currently downloads a pre-release package
[Jver.VerifyMicrosoftPackage](https://www.nuget.org/packages/Jver.VerifyMicrosoftPackage). This will be switched
to [NuGet.VerifyMicrosoftPackage](https://www.nuget.org/packages/NuGet.VerifyMicrosoftPackage) later. Also, the
`verify.ps1` URL will change to the `master` branch once this tool have been approved by some internal teams.
