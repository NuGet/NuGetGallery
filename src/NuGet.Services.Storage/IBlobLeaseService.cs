...
namespace NuGet.Services.Storage
{
    ...
    public interface IBlobLeaseService
    {
        ...
        Task<BlobLeaseResult> TryAcquireAsync(string resourceName, TimeSpan leaseTime, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns>The lease result.</returns>
        Task<BlobLeaseResult> RenewAsync(string resourceName, string leaseId, CancellationToken cancellationToken);
    }
}