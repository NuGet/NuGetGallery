$(function () {
    ...
    var emailBox = $("#" + emailBoxGroupId + " > input");
    var gravatar = $("#" + gravatarId);
    var template = "https://secure.gravatar.com/avatar/{email}?s=512&r=g&d=retro";
    ...
    function updateGravatar() {
        ...
        if (email.match(/^([0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*@([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,9})$/)) {
            src = template.replace("{email}", md5(email));
        }

        gravatar.attr("src", src);
    }
});