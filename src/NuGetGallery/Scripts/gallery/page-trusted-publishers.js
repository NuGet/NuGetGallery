(function () {
    ...
    $(function () {
        ...
        function TrustedPublisherViewModel(parent, packageOwners, data) {
            ...
            this.PublisherDetails = ko.observable();
            ...
            this._UpdateData = function(data) {
                ...
                // Create appropriate publisher details based on type
                this.PublisherDetails(null);
                const publisherDetails = data.PublisherDetails;
                if (data.PublisherName === 'GitHub') {
                    this.PublisherDetails({
                        RepositoryOwner: publisherDetails.RepositoryOwner || '',
                        Repository: publisherDetails.Repository || '',
                        WorkflowFile: publisherDetails.WorkflowFile || '',
                        Environment: publisherDetails.Environment || '',
                        Name: "GitHub",
                    });
                }
            };
        ...
        function TrustedPublisherListViewModel(initialData) {
            ...
            var trustedPublisher = $.map(initialData.TrustedPublishers, function (data) {
            ...
            this.TrustedPublishers = ko.observableArray(trustedPublisher);
