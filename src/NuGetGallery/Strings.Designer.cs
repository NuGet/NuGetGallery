...
namespace NuGetGallery {
    ...
    public class Strings {
        ...
        /// <summary>
        ///   Ensures that the API key expiration must be 1, 8, or 30 days.
        /// </summary>
        public static string ApiKeyExpirationNotAllowed
        {
            get {
                return ResourceManager.GetString("ApiKeyExpirationNotAllowed", resourceCulture);
            }
        }
