...
namespace NuGetGallery
{
        ...
        : AppController
    {
        ...
        private interface IScopeSubject
        {
            ...
            PermissionsFailure IsActionAllowed(User currentUser, User owner);
        }
        ...
        private class NewScopeSubject : IScopeSubject
        {
            ...
            public PermissionsFailure IsActionAllowed(User currentUser, User owner)
            {
                return _action.IsAllowed(currentUser, owner, _context);
            }
        }
        ...
        private class ExistingScopeSubject : IScopeSubject
        {
            ...
            public PermissionsFailure IsActionAllowed(User currentUser, User owner)
            {
                return _action.IsAllowed(currentUser, owner, _packageRegistration);
            }
        }
        ...
        private ApiScopeEvaluationResult EvaluateApiScope(IScopeSubject scopeSubject, out User owner, params string[] requestedActions)
        {
            ...
            foreach (var scope in scopes)
            {
                ...
                var isActionAllowed = scopeSubject.IsActionAllowed(currentUser, ownerInScope);
                if (isActionAllowed != PermissionsFailure.None)
                {
                    ...
                    if (isActionAllowed == PermissionsFailure.ReservedNamespace)
                    {
