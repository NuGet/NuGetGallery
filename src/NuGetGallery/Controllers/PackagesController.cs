        ...
        : AppController
    {
        ...
        public virtual async Task<JsonResult> UploadPackage(HttpPostedFileBase uploadFile)
        {
            ...
            using (var uploadStream = uploadFile.InputStream)
            {
                ...
                if (packageRegistration != null && !PackagePermissionsService.HasPermission(packageRegistration, currentUser, PackageAction.UploadNewVersion))
                {
                    ModelState.AddModelError(
        ...
        public virtual async Task<ActionResult> DisplayPackage(string id, string version)
        {
            ...
            if (package == null
                || ((package.PackageStatusKey == PackageStatus.Validating
                    ...
                    && !PackagePermissionsService.HasPermission(package, User, PackageAction.DisplayPrivatePackage)))
            {
                return HttpNotFound();
            }
            ...
            if (PackagePermissionsService.HasPermission(package, User, PackageAction.Edit))
            {
        ...
        public virtual ActionResult ReportAbuse(string id, string version)
        {
            ...
            if (Request.IsAuthenticated)
            {
                ...
                if (PackagePermissionsService.HasPermission(package, user, PackageAction.ReportMyPackage))
                {
        ...
        public virtual ActionResult ManagePackageOwners(string id)
        {
            ...
            if (!PackagePermissionsService.HasPermission(package, User, PackageAction.ManagePackageOwners))
            {
