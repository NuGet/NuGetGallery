        ...
        : AppController
    {
        ...
        public async virtual Task<ActionResult> UploadPackage()
        {
            ...
            using (var uploadedFile = await _uploadFileService.GetUploadFileAsync(currentUser.Key))
            {
                if (uploadedFile != null)
                {
                    ...
                    {
                        ActionsRequiringPermissions.UploadNewPackageId.TryGetAccountsIsAllowedOnBehalfOf(currentUser, new ActionOnNewPackageContext(packageMetadata.Id, _reservedNamespaceService), out accountsAllowedOnBehalfOf);
                    }
                    else
                    {
                        ActionsRequiringPermissions.UploadNewPackageVersion.TryGetAccountsIsAllowedOnBehalfOf(currentUser, existingPackageRegistration, out accountsAllowedOnBehalfOf);
                    }
        ...
        public virtual async Task<JsonResult> UploadPackage(HttpPostedFileBase uploadFile)
        {
            ...
            using (var uploadStream = uploadFile.InputStream)
            {
                ...
                if (existingPackageRegistration == null && !ActionsRequiringPermissions.UploadNewPackageId.TryGetAccountsIsAllowedOnBehalfOf(currentUser, new ActionOnNewPackageContext(id, _reservedNamespaceService), out accountsAllowedOnBehalfOf))
                {
                    ModelState.AddModelError(
                ...
                if (existingPackageRegistration != null && !ActionsRequiringPermissions.UploadNewPackageVersion.TryGetAccountsIsAllowedOnBehalfOf(currentUser, existingPackageRegistration, out accountsAllowedOnBehalfOf))
                {
                    ModelState.AddModelError(
        ...
        public virtual ActionResult ReportAbuse(string id, string version)
        {
            ...
            if (Request.IsAuthenticated)
            {
                ...
                if (ActionsRequiringPermissions.ReportPackageAsOwner.TryGetAccountsIsAllowedOnBehalfOf(user, package, out var accountsAllowedOnBehalfOf))
                {
        ...
        public virtual async Task<ActionResult> ReportMyPackage(string id, string version)
        {
            ...
            if (!ActionsRequiringPermissions.ReportPackageAsOwner.TryGetAccountsIsAllowedOnBehalfOf(GetCurrentUser(), package, out var accountsAllowedOnBehalfOf))
            {
        ...
        public virtual ActionResult ManagePackageOwners(string id)
        {
            ...
            if (!ActionsRequiringPermissions.ManagePackageOwnership.TryGetAccountsIsAllowedOnBehalfOf(GetCurrentUser(), package, out var accountsAllowedOnBehalfOf))
            {
        ...
        public virtual ActionResult Delete(string id, string version)
        {
            ...
            if (!ActionsRequiringPermissions.UnlistOrRelistPackage.TryGetAccountsIsAllowedOnBehalfOf(GetCurrentUser(), package, out var accountsAllowedOnBehalfOf))
            {
                return new HttpStatusCodeResult(401, "Unauthorized");
            }
        ...
        public virtual async Task<ActionResult> Edit(string id, string version)
        {
            ...
            if (!ActionsRequiringPermissions.EditPackage.TryGetAccountsIsAllowedOnBehalfOf(GetCurrentUser(), package, out var accountsAllowedOnBehalfOf))
            {
        ...
        private async Task<ActionResult> HandleOwnershipRequest(string id, string username, string token, bool accept)
        {
            ...
            if (ActionsRequiringPermissions.HandlePackageOwnershipRequest.IsAllowed(GetCurrentUser(), user) != PermissionsFailure.None)
            {
        ...
        public virtual async Task<JsonResult> VerifyPackage(VerifyPackageRequest formData)
        {
            ...
            using (Stream uploadFile = await _uploadFileService.GetUploadFileAsync(currentUser.Key))
            {
                ...
                if (existingPackageRegistration == null)
                {
                    var checkPermissionsOfUploadNewId = ActionsRequiringPermissions.UploadNewPackageId.IsAllowed(currentUser, owner, new ActionOnNewPackageContext(packageId, _reservedNamespaceService));
                    if (checkPermissionsOfUploadNewId != PermissionsFailure.None)
                    {
                        if (checkPermissionsOfUploadNewId == PermissionsFailure.Account)
                        {
                        ...
                        else if (checkPermissionsOfUploadNewId == PermissionsFailure.ReservedNamespace)
                        {
                ...
                {
                    var checkPermissionsOfUploadNewVersion = ActionsRequiringPermissions.UploadNewPackageVersion.IsAllowed(currentUser, owner, existingPackageRegistration);
                    if (checkPermissionsOfUploadNewVersion != PermissionsFailure.None)
                    {
                        if (checkPermissionsOfUploadNewVersion == PermissionsFailure.Account)
                        {
                        ...
                        if (checkPermissionsOfUploadNewVersion == PermissionsFailure.PackageRegistration)
                        {
