...
namespace NuGetGallery.Controllers
{
        ...
        : NuGetODataController
    {
        ...
        public async Task<IHttpActionResult> Get(ODataQueryOptions<V2FeedPackage> options)
        {
                ...
                if (_searchService is ExternalSearchService && SearchHijacker.IsHijackable(options, out hijackableQueryParameters))
                {
                    ...
                    if (searchAdaptorResult.ResultsAreProvidedBySearchService)
                    {
                        ...
                        var pagedQueryable = packages
                            ...
                            .ToV2FeedPackageQuery(GetSiteRoot(), (await _configurationService.GetFeatures()).FriendlyLicenses);
            ...
            var queryable = packages.ToV2FeedPackageQuery(GetSiteRoot(), (await _configurationService.GetFeatures()).FriendlyLicenses);
            ...
            [FromODataUri]bool includePrerelease = false)
        {
            ...
            var queryable = query.ToV2FeedPackageQuery(GetSiteRoot(), (await _configurationService.GetFeatures()).FriendlyLicenses);
            return QueryResult(options, queryable, MaxPageSize);
        }
        ...
        public async Task<IHttpActionResult> GetUpdatesCount(
            ...
            [FromODataUri]string versionConstraints = "")
        {
            return (await GetUpdates(options, packageIds, versions, includePrerelease, includeAllVersions, targetFrameworks, versionConstraints))
