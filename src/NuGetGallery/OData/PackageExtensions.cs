...
namespace NuGetGallery.OData
{
    public static class PackageExtensions
    {
            ...
            return packages
                ...
                .Select(
                    p => new V1FeedPackage
                    {
                        ...
                        IconUrl = p.IconUrl,
                        // We do not project SemVer2 equivalent of IsLatestStable on v1 feeds as SemVer2 is not supported on this endpoint.
        ...
        public static IQueryable<V2FeedPackage> ToV2FeedPackageQuery(this IQueryable<Package> packages, string siteRoot, bool includeLicenseReport, int? semVerLevelKey)
        {
        ...
        internal static IQueryable<V2FeedPackage> ProjectV2FeedPackage(this IQueryable<Package> packages, string siteRoot, bool includeLicenseReport, int? semVerLevelKey)
        {
            siteRoot = EnsureTrailingSlash(siteRoot);
