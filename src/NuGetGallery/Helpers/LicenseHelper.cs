...
namespace NuGetGallery
{
    ...
    {
        public static HashSet<string> StandardLicenses => new HashSet<string> {
            "0BSD",
            "AAL",
            "Abstyles",
            "Adobe-2006",
        ...
        public static HashSet<string> DeprecatedLicenses => new HashSet<string> {
            "AGPL-1.0",
            "AGPL-3.0",
            "eCos-2.0",
            "GFDL-1.1",
        ...
        public static HashSet<string> StandardExceptions => new HashSet<string> {
            "389-exception",
