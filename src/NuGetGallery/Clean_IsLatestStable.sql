...
FROM Packages
where PackageRegistrationKey = @RegistrationKey and Deleted = 0 and Listed = 1 and IsPrerelease = 0
...
UPDATE Packages SET IsLatestStable = 1 WHERE NormalizedVersion = @LatestVersion and PackageRegistrationKey = @RegistrationKey
END TRY
BEGIN CATCH
BEGIN TRY
