...
namespace NuGetGallery
{
    public interface IDeleteAccountService
    {
        ...
        /// <param name="userExecutingTheDelete">The user that will execute the delete action.</param>
        ...
        /// <returns></returns>
        Task<DeleteUserAccountStatus> DeleteGalleryUserAccountAsync(User userToBeDeleted, User userToExecuteTheDelete, string signature, bool unsignOrphanPackages, bool commitAsTransaction);
    }
}
