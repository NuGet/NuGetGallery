...
namespace NuGetGallery
{
    public class PackageIndexEntity
    {
        ...
        public Document ToDocument()
        {
            ...
            document.Add(new Field("Version", Package.Version, Field.Store.YES, Field.Index.NO));
            document.Add(new Field("NormalizedVersion", SemanticVersionExtensions.Normalize(Package.Version), Field.Store.YES, Field.Index.NO));
