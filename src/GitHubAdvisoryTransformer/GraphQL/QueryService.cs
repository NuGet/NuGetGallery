...
namespace GitHubAdvisoryTransformer.GraphQL
{
    public class QueryService : IQueryService
    {
        ...
        /// </remarks>
        public const string UserAgent = "NuGet.Jobs.GitHubAdvisoryTransformer";

        private readonly GitHubAdvisoryTransformerConfiguration _configuration;
        private readonly HttpClient _client;

        public QueryService(
            GitHubAdvisoryTransformerConfiguration configuration,
            HttpClient client)
        {
