...
{
    internal static class CatalogValidationIssueExtensions
    {
        /// <summary>
        /// Returns a Markdown representation describing the <see cref="ValidationIssue"/> in a user-friendly way.
        /// </summary>
        public static string ToMarkdownString(this CatalogValidationIssue validationIssue, string announcementsUrl, string twitterUrl)
        {
