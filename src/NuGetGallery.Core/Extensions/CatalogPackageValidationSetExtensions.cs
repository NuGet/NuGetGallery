...
using NuGet.Services.CatalogValidation.Issues;

namespace NuGetGallery
{
    public static class CatalogPackageValidationSetExtensions
    {
        public static IReadOnlyList<CatalogValidationIssue> GetCatalogValidationIssues(this PackageValidationSet validationSet)
        {
            IReadOnlyList<CatalogValidationIssue> issues = null;
            ...
            if (validationSet != null)
            {
                ...
                issues = validationSet
                    ...
                    .OrderBy(i => i.Key)
                    .Select(i => CatalogValidationIssue.Deserialize(i.IssueCode, i.Data))
                    .ToList();
            ...
            {
                issues = new[] { CatalogValidationIssue.Unknown };
            }
