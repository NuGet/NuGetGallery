...
(
	...
	CONSTRAINT [PK_Fact_Package_PackageSet] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
    CONSTRAINT [FK_Fact_Package_PackageSet_Dimension_Package] FOREIGN KEY ([Dimension_Package_Id]) REFERENCES [dbo].[Dimension_Package]([Id]),
