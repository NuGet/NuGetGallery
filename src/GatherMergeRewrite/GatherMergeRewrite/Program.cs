...
namespace GatherMergeRewrite
{
    class Program
    {
        ...
        static void Test1()
        {
            ...
            string ownerId = "microsoft";
            //string registrationId = "iesi.collections";
            //string registrationId = "entityframework";
            //string registrationId = "log4net";
            //string registrationId = "elmah";
            string registrationId = "lucene.net";
            ...
            { 
                //new LocalPackageHandle(ownerId, registrationId, path + "iesi.collections.1.0.1.nupkg", DateTime.Now),
                //new LocalPackageHandle(ownerId, registrationId, path + "entityframework.5.0.0.nupkg", DateTime.Now),
                //new LocalPackageHandle(ownerId, registrationId, path + "log4net.1.2.10.nupkg", DateTime.Now),
                //new LocalPackageHandle(ownerId, registrationId, path + "elmah.1.1.0.nupkg", DateTime.Now),
                new LocalPackageHandle(ownerId, registrationId, path + "lucene.net.3.0.3-rc2.nupkg", DateTime.Now),
            };
        ...
        static void Test4()
        {
            //string accountKey = "KD6kANHO/jSm3zA4zEl+iNdgfjDkw0dJm3fns8GZOFlH0WunqkO32RbJlTsEq1lrTiQoYxFGiogH7JF8xqdmiw==";
            //IStorage storage = new AzureStorage
            //{
