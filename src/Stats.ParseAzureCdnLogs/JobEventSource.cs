...
namespace Stats.ParseAzureCdnLogs
{
        ...
        : EventSource
    {
        ...
        [Event(eventId: 11, Level = EventLevel.Informational, Message = "Finished to parse blob {0}", Task = Tasks.ParseLog, Opcode = EventOpcode.Stop)]
        public void FinishingParseLog(string uri)
        {
            WriteEvent(11, uri);
        }
        ...
        [Event(eventId: 13, Level = EventLevel.Informational, Message = "Beginning table batch insert log entries for blob {0}", Task = Tasks.TableBatchInsert, Opcode = EventOpcode.Start)]
        public void BeginningBatchInsert(string uri)
        {
            WriteEvent(13, uri);
        }

        [Event(eventId: 14, Level = EventLevel.Informational, Message = "Finished table batch insert log entries for blob {0}", Task = Tasks.TableBatchInsert, Opcode = EventOpcode.Stop)]
        public void FinishingBatchInsert(string uri)
        {
            WriteEvent(14, uri);
        }

        [Event(eventId: 15, Level = EventLevel.Error, Message = "Failed table batch insert log entries for blob {0}", Task = Tasks.TableBatchInsert, Opcode = EventOpcode.Suspend)]
        public void FailedBatchInsert(string uri)
        {
            WriteEvent(15, uri);
        }

        [Event(eventId: 16, Level = EventLevel.Informational, Message = "Beginning archive upload for blob {0}", Task = Tasks.UploadArchive, Opcode = EventOpcode.Start)]
        public void BeginningArchiveUpload(string uri)
        {
            WriteEvent(16, uri);
        }

        [Event(eventId: 17, Level = EventLevel.Informational, Message = "Finished archive upload for blob {0}", Task = Tasks.UploadArchive, Opcode = EventOpcode.Stop)]
        public void FinishingArchiveUpload(string uri)
        {
            WriteEvent(17, uri);
        }

        [Event(eventId: 18, Level = EventLevel.Error, Message = "Failed archive upload for blob {0}", Task = Tasks.UploadArchive, Opcode = EventOpcode.Suspend)]
        public void FailedArchiveUpload(string uri)
        {
            WriteEvent(18, uri);
        }

        [Event(eventId: 19, Level = EventLevel.Informational, Message = "Beginning to delete blob {0}", Task = Tasks.DeleteBlob, Opcode = EventOpcode.Start)]
        public void BeginningDelete(string uri)
        {
            WriteEvent(19, uri);
        }

        [Event(eventId: 20, Level = EventLevel.Informational, Message = "Finished to delete blob {0}", Task = Tasks.DeleteBlob, Opcode = EventOpcode.Stop)]
        public void FinishedDelete(string uri)
        {
            WriteEvent(20, uri);
        }

        [Event(eventId: 21, Level = EventLevel.Error, Message = "Failed to delete blob {0}", Task = Tasks.DeleteBlob, Opcode = EventOpcode.Suspend)]
        ...
        public static class Tasks
        {
            ...
            public const EventTask TableBatchInsert = (EventTask)0x5;
            public const EventTask UploadArchive = (EventTask)0x6;
            public const EventTask DeleteBlob = (EventTask)0x7;
        }
    }
}