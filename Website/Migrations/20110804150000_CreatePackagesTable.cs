    ...
    public class CreatePackagesTableMigration : Migration
    {
        public override void Up()
        {
            ...
            Database.AddTable("Packages",
                ...
                new Column("Copyright", DbType.String, ColumnProperty.Null),
                ...
                new Column("ExternalPackageUrl", DbType.String, ColumnProperty.Null),
                new Column("HashAlgorithm", DbType.String, ColumnProperty.NotNull),
                new Column("Hash", DbType.String, ColumnProperty.NotNull),
                new Column("IconUrl", DbType.String, ColumnProperty.Null),
                ...
                new Column("LicenseUrl", DbType.String, ColumnProperty.Null),
                new Column("PackageFileSize", DbType.Int64, ColumnProperty.NotNull),
                new Column("ProjectUrl", DbType.String, ColumnProperty.Null),
                ...
                new Column("Summary", DbType.String, ColumnProperty.Null),
