...
namespace NuGetGallery
{
    public class LuceneIndexingService : IIndexingService
    {
        ...
        private void AddPackage(Package package)
        {
            ...
            // Authors and Dependencies have flattened representations in the data model.
            // The Authors one is literally input as flattened text by the package creator. The FlattenedDepencies is programmatically generated
            document.Add(new Field("Author", package.FlattenedAuthors, Field.Store.YES, Field.Index.ANALYZED));
            document.Add(new Field("FlattenedDependencies", package.FlattenedDependencies, Field.Store.YES, Field.Index.NO));
            ...
            document.Add(new Field("PackageHash", package.Hash.ToStringSafe(), Field.Store.YES, Field.Index.NO));
            document.Add(new Field("PackageHashAlgorithm", package.HashAlgorithm.ToStringSafe(), Field.Store.YES, Field.Index.NO));
