...
7. Change the value of Gallery.ConfirmEmailAddresses to false in Web.Config file under src\NuGetGallery. This step is required to upload the packages after registration.
