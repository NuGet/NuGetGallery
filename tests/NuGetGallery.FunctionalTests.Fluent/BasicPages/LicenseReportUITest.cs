...
namespace NuGetGallery.FunctionalTests.Fluent.BasicPages
{
    ...
    {
        public LicenseReportUITest(ITestOutputHelper testOutputHelper)
        ...
        [Fact(Skip = "This test involves a long process for Sonatype to process the License URLs and present it on the UI. Ignore it for now.")]
        ...
        [Priority(2)]
        public async Task LicenseReportUI()
        {
            if (CheckForPackageExistence)
            {
                ...
                await UploadPackageIfNecessary("NuGetGallery.FunctionalTests.Fluent.LicenseReportUITest.MIT", "1.0.0", null, null, null, null, "http://choosealicense.com/licenses/mit/");
                await UploadPackageIfNecessary("NuGetGallery.FunctionalTests.Fluent.LicenseReportUITest.Apache", "1.0.0", null, null, null, null, "http://choosealicense.com/licenses/apache/");
                await UploadPackageIfNecessary("NuGetGallery.FunctionalTests.Fluent.LicenseReportUITest.GPL2", "1.0.0", null, null, null, null, "http://choosealicense.com/licenses/gpl-v2/");
                await UploadPackageIfNecessary("NuGetGallery.FunctionalTests.Fluent.LicenseReportUITest.GPL3", "1.0.0", null, null, null, null, "http://choosealicense.com/licenses/gpl-v3/");
                await UploadPackageIfNecessary("NuGetGallery.FunctionalTests.Fluent.LicenseReportUITest.NoLicense", "1.0.0", null, null, null, null, null);
            }
