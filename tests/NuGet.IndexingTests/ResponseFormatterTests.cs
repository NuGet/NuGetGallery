        ...
        public static IEnumerable<object[]> V2ResultData
        {
            get
            {
                ...
                yield return new object[]
                {
                    ...
                    0,    // skip
                    2,    // take
                    string.Format("{{\"totalHits\":2,\"index\":\"mockTakeDocuments\",\"indexTimestamp\":\"{0:G}\",\"data\":[{{\"PackageRegistration\":{{\"{2}\":\"{1}{2}0\",\"DownloadCount\":0,\"Verified\":false,\"Owners\":[]}},\"Version\":\"{1}{10}0\",\"NormalizedVersion\":\"{1}{3}0\",\"{4}\":\"{1}{4}0\",\"{5}\":\"{1}{5}0\",\"{6}\":\"{1}{6}0\",\"{7}\":\"{1}{7}0\",\"{8}\":\"{1}{8}0\",\"IsLatestStable\":false,\"IsLatest\":false,\"Listed\":true,\"DownloadCount\":0,\"Dependencies\":[],\"SupportedFrameworks\":[],\"PackageFileSize\":0,\"{9}\":\"{1}{9}0\",\"RequiresLicenseAcceptance\":false}},{{\"PackageRegistration\":{{\"{2}\":\"{1}{2}1\",\"DownloadCount\":0,\"Verified\":false,\"Owners\":[]}},\"Version\":\"{1}{10}1\",\"NormalizedVersion\":\"{1}{3}1\",\"{4}\":\"{1}{4}1\",\"{5}\":\"{1}{5}1\",\"{6}\":\"{1}{6}1\",\"{7}\":\"{1}{7}1\",\"{8}\":\"{1}{8}1\",\"IsLatestStable\":false,\"IsLatest\":false,\"Listed\":true,\"DownloadCount\":0,\"Dependencies\":[],\"SupportedFrameworks\":[],\"PackageFileSize\":0,\"{9}\":\"{1}{9}1\",\"RequiresLicenseAcceptance\":false}}]}}",
        ...
        public static IEnumerable<object[]> SearchResultData
        {
            get
            {
                ...
                yield return new object[]
                {
                    ...
                    "{{\"@context\":{{\"@vocab\":\"http://schema.nuget.org/schema#\",\"@base\":\"{0}\"}},\"totalHits\":1,\"lastReopen\":\"{1:o}\",\"index\":\"{2}IncludeExplanations\",\"data\":[{{\"@id\":\"{0}{2}{3}0/index.json\",\"@type\":\"Package\",\"registration\":\"{0}{2}{3}0/index.json\",\"id\":\"{4}{5}0\",\"version\":\"{4}{6}0\",\"description\":\"{4}{7}0\",\"summary\":\"{4}{8}0\",\"title\":\"{4}{9}0\",\"iconUrl\":\"{4}{10}0\",\"licenseUrl\":\"{4}{11}0\",\"projectUrl\":\"{4}{12}0\",\"totalDownloads\":0,\"verified\":false,\"versions\":[]}},{{\"@id\":\"{0}{2}{3}1/index.json\",\"@type\":\"Package\",\"registration\":\"{0}{2}{3}1/index.json\",\"id\":\"{4}{5}1\",\"version\":\"{4}{6}1\",\"description\":\"{4}{7}1\",\"summary\":\"{4}{8}1\",\"title\":\"{4}{9}1\",\"iconUrl\":\"{4}{10}1\",\"licenseUrl\":\"{4}{11}1\",\"projectUrl\":\"{4}{12}1\",\"totalDownloads\":0,\"verified\":false,\"versions\":[]}}]}}"
                };
