...
namespace NuGetGallery.Services
{
	public class SponsorshipUrlServiceFacts
	{
		...
		public class TheAddSponsorshipUrlAsyncMethod
		{
			...
			public async Task ThrowsSponsorshipUrlValidationExceptionForInvalidUrl(string invalidUrl)
			{
				// Arrange
				var service = CreateService();
				var packageRegistration = CreatePackageRegistration();
				...
				// Act & Assert
				await Assert.ThrowsAsync<SponsorshipUrlValidationException>(() => 
					service.AddSponsorshipUrlAsync(packageRegistration, invalidUrl, user));
			}

			[Fact]
			public async Task ThrowsSponsorshipUrlValidationExceptionForUrlTooLong()
			{
				// Arrange
				var service = CreateService();
				var packageRegistration = CreatePackageRegistration();
				...
				// Act & Assert
				var ex = await Assert.ThrowsAsync<SponsorshipUrlValidationException>(() => 
		...
		public class TheRemoveSponsorshipUrlAsyncMethod
		{
			...
			[Fact]
			public async Task ThrowsSponsorshipUrlValidationExceptionWhenUrlNotFound()
			{
				// Arrange
				var service = CreateService();
				var packageRegistration = CreatePackageRegistration();
