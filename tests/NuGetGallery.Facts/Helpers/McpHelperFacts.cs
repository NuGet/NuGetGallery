...
namespace NuGetGallery.Helpers
{
    public class McpHelperFacts
    {
        ...
        public class CreateVsCodeMcpServerEntryTemplateMethod
        {
            ...
            [InlineData(McpServerData.ServerJsonPositionalWithValue, McpServerData.McpJsonPositionalWithValue)]
            [InlineData(McpServerData.ServerJsonPositionalWithValueHint, McpServerData.McpJsonPositionalWithValueHint)]
            [InlineData(McpServerData.ServerJsonPositionalWithValueHintDescription, McpServerData.McpJsonPositionalWithValueHintDescription)]
            [InlineData(McpServerData.ServerJsonPositionalWithValueHintChoices, McpServerData.McpJsonPositionalWithValueHintChoices)]
            [InlineData(McpServerData.ServerJsonPositionalWithValueHintDefault, McpServerData.McpJsonPositionalWithValueHintDefault)]
            [InlineData(McpServerData.ServerJsonNamedWithValue, McpServerData.McpJsonNamedWithValue)]
            [InlineData(McpServerData.ServerJsonNamedWithDescription, McpServerData.McpJsonNamedWithDescription)]
            [InlineData(McpServerData.ServerJsonNamedWithChoices, McpServerData.McpJsonNamedWithChoices)]
            [InlineData(McpServerData.ServerJsonNamedWithDefault, McpServerData.McpJsonNamedWithDefault)]
            [InlineData(McpServerData.ServerJsonNamedWithNoValueNoDescriptionNoChoicesNoDefault, McpServerData.McpJsonNamedWithNoValueNoDescriptionNoChoicesNoDefault)]
            [InlineData(McpServerData.ServerJsonEnvWithValueVariable, McpServerData.McpJsonEnvWithValueVariable)]
            [InlineData(McpServerData.ServerJsonEnvWithDescriptionNoValue, McpServerData.McpJsonEnvWithDescriptionNoValue)]
            [InlineData(McpServerData.ServerJsonEnvWithChoicesNoValue, McpServerData.McpJsonEnvWithChoicesNoValue)]
            [InlineData(McpServerData.ServerJsonEnvWithDefaultNoValue, McpServerData.McpJsonEnvWithDefaultNoValue)]
            [InlineData(McpServerData.ServerJsonEnvWithNoValue, McpServerData.McpJsonEnvWithNoValue)]
