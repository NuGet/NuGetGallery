...
/*        [InlineData("http://api.bintray.com/example/image.svg", false, null, false)]
        ...
        [InlineData("https://badges.frapsoft.com/example/image.svg", true, "https://badges.frapsoft.com/example/image.svg", true)]
        [InlineData("https://badges.frapsoft.com/example/image.svg", false, "https://badges.frapsoft.com/example/image.svg", true)]
        [InlineData("http://badges.frapsoft.com/example/image.svg", true, "https://badges.frapsoft.com/example/image.svg", true)]
        ...
        [InlineData("https://build.appcenter.ms/example/image.svg", true, "https://build.appcenter.ms/example/image.svg", true)]
        [InlineData("https://build.appcenter.ms/example/image.svg", false, "https://build.appcenter.ms/example/image.svg", true)]
        [InlineData("http://build.appcenter.ms/example/image.svg", true, "https://build.appcenter.ms/example/image.svg", true)]
        [InlineData("http://build.appcenter.ms/example/image.svg", false, null, false)]
        ...
        [InlineData("https://codeclimate.com/example/image.svg", true, "https://codeclimate.com/example/image.svg", true)]
        [InlineData("https://codeclimate.com/example/image.svg", false, "https://codeclimate.com/example/image.svg", true)]
        [InlineData("http://codeclimate.com/example/image.svg", true, "https://codeclimate.com/example/image.svg", true)]
        ...
        [InlineData("https://github.com/4lejandrito/creepyface/actions?query=workflow%3ABuild+branch%3Amaster.png", true, "https://github.com/4lejandrito/creepyface/actions?query=workflow%3ABuild+branch%3Amaster.png", false)]
        ...
        [InlineData("https://skyapmtest.github.io/page-resources/SkyAPM/skyapm.png", true, "https://skyapmtest.github.io/page-resources/SkyAPM/skyapm.png", true)]
        ...
        [InlineData("https://travis-ci.com/example/image.svg", true, "https://travis-ci.com/example/image.svg", true)]
        [InlineData("https://travis-ci.org/example/image.svg", true, "https://travis-ci.org/example/image.svg", true)]
        [InlineData("https://feeds.dev.azure.com/example/image.svg", true, "https://feeds.dev.azure.com/example/image.svg", true)]
        ...
        [InlineData("https://travis-ci.org/Azure/azure-relay-aspnetserver.svg?branch=dev", true, "https://travis-ci.org/Azure/azure-relay-aspnetserver.svg?branch=dev", true)]
        [InlineData("https://travis-ci.org/Azure/azure-relay-aspnetserver.svg?branch=dev", true, "https://travis-ci.org/Azure/azure-relay-aspnetserver.svg?branch=dev", true)]
