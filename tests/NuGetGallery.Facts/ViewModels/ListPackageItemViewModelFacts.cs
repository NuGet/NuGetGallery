...
namespace NuGetGallery.ViewModels
{
    public class ListPackageItemViewModelFacts
    {
        ...
        public void UsesNormalizedVersionForDisplay()
        {
            ...
            var packageViewModel = new ListPackageItemViewModelHelper().CreateListPackageItemViewModel(package, currentUser: null);
        ...
        public void ShortDescriptionsNotTruncated()
        {
            ...
            var listPackageItemViewModel = new ListPackageItemViewModelHelper().CreateListPackageItemViewModel(package, currentUser: null);
...
#pragma warning restore 0618
        ...
        public class SignerInformation
        {
            ...
            {
                var viewModel = new ListPackageItemViewModelHelper().CreateListPackageItemViewModel(_package, _user1);
