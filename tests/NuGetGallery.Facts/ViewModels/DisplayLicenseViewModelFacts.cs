...
namespace NuGetGallery.ViewModels
{
    public class DisplayLicenseViewModelHelperFacts
    {
        ...
        public void ItInitializesLicenseFileTypeAndLicenseExpression(EmbeddedLicenseFileType embeddedLicenseType, string licenseExpression)
        {
            ...
            // act
            var model = new DisplayLicenseViewModelHelper().Create(package, licenseExpressionSegments: null, licenseFileContents: null);
        ...
        public void ItInitializesLicenseExpressionSegments()
        {
            ...
            // act
            var model = new DisplayLicenseViewModelHelper().Create(package, licenseExpressionSegments: segments, licenseFileContents: null);
        ...
        public void ItInitializesLicenseFileContents()
        {
            ...
            // act
            var model = new DisplayLicenseViewModelHelper().Create(package, licenseExpressionSegments: null, licenseFileContents: licenseFileContents);
