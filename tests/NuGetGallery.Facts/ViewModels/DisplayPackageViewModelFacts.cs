...
namespace NuGetGallery.ViewModels
{
    public class DisplayPackageViewModelFacts
    {
        ...
        public void ItDeterminesRepositoryKind(string repoUrl, string repoType, RepositoryKind expectedKind, string expectedUrl)
        {
            ...
            var model = new DisplayPackageViewModelHelper().Create(package, currentUser: null, deprecation: null, readmeHtml: null);
        ...
        public void LicenseNamesAreParsedByCommas()
        {
            ...
            var packageViewModel = new DisplayPackageViewModelHelper().Create(package, currentUser: null, deprecation: null, readmeHtml: null);
        ...
        public void TheCtorSortsPackageVersionsProperly()
        {
            ...
            var packageVersions = new DisplayPackageViewModelHelper().Create(package, currentUser: null, deprecation: null, readmeHtml: null)
        ...
        public void TheCtorDoesNotPopulateLatestSymbolsPackageForHistory()
        {
            ...
            var viewModel = new DisplayPackageViewModelHelper().Create(package, currentUser: null, deprecation: null, readmeHtml: null);
        ...
        public class ThePushedByField
        {
            ...
            {
                var model = new DisplayPackageViewModelHelper().Create(package, currentUser, deprecation: null, readmeHtml: null);
            ...
            bool hasAlternatePackage)
        {
            ...
            // Act
            var model = new DisplayPackageViewModelHelper().Create(package, currentUser: null, deprecation: deprecation, readmeHtml: null);
