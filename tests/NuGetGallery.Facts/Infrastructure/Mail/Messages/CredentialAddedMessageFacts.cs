...
{
    public class CredentialAddedMessageFacts : MarkdownMessageBuilderFacts
    {
        public class TheConstructor
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => new CredentialAddedMessage(
                    configuration,
                    user,
                    credentialTypeInfo));
            }
        ...
        private static CredentialAddedMessage CreateMessage(CredentialTypeInfo credentialTypeInfo)
        {
            return new CredentialAddedMessage(
                Configuration,
        ...
        private const string _expectedMessageBodyForApiKey =
            @"API key 'Api Key description' was added to your account and can now be used. If you did not request this change, please reply to this email to contact support.";

        private const string _expectedMessageBodyForNonApiKey =
            @"A Microsoft Account was added to your account and can now be used to sign in. If you did not request this change, please reply to this email to contact support.";
    }
}
