    ...
    public class ControllerTests
    {
        ...
        public void AllActionsHaveAntiForgeryTokenIfNotGet()
        {
            ...
            var exceptions = new ControllerActionRuleException[]
            {
                ...
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.PushStagingPackage)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.SetStagedPackageListed)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.DeleteStagedPackage)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.DeleteStagedSymbolsPackage)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.CreateStagingGroup)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.RenameStagingGroup)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.DeleteStagingGroup)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.AddPackageToStagingGroup)),
                new ControllerActionRuleException(typeof(StagingController), nameof(StagingController.RemovePackageFromStagingGroup)),
