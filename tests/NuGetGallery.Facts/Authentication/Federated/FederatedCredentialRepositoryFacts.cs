...
namespace NuGetGallery.Services.Authentication
{
    ...
    {
        public class TheGetPoliciesForUserMethod : FederatedCredentialRepositoryFacts
        {
            [Fact]
            public void FiltersByUserKey()
            {
                // Act
                var policies = Target.GetPoliciesForUser(userKey: 4);
        ...
        public FederatedCredentialRepositoryFacts()
        {
            ...
            {
                new() { Key = 1, UserKey = 4, OwnerKey = 4 },
                new() { Key = 2, UserKey = 4, OwnerKey = 8 },
                new() { Key = 3, UserKey = 5, OwnerKey = 9 },
            };
