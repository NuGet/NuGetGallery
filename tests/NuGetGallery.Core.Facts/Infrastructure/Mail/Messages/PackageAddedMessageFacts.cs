...
{
    public class PackageAddedMessageFacts : MarkdownMessageBuilderFacts
    {
        public class TheConstructor
        {
            public static IEnumerable<object[]> ConstructorArguments
            {
                get
                {
                    yield return new object[] { null, Fakes.Package, Fakes.PackageUrl, Fakes.PackageSupportUrl, Fakes.EmailSettingsUrl, It.IsAny<IEnumerable<string>>() };
                    ...
                    yield return new object[] { Configuration, Fakes.Package, null, Fakes.PackageSupportUrl, Fakes.EmailSettingsUrl, It.IsAny<IEnumerable<string>>() };
                    yield return new object[] { Configuration, Fakes.Package, Fakes.PackageUrl, null, Fakes.EmailSettingsUrl, It.IsAny<IEnumerable<string>>() };
                    yield return new object[] { Configuration, Fakes.Package, Fakes.PackageUrl, Fakes.PackageSupportUrl, null, It.IsAny<IEnumerable<string>>() };
                }
            }
            ...
            {
                Assert.Throws<ArgumentNullException>(() => new PackageAddedMessage(
                    configuration,
                    package,
                    packageUrl,
                    packageSupportUrl,
        ...
        private static PackageAddedMessage CreateMessage(IEnumerable<string> warningMessages = null)
        {
            return new PackageAddedMessage(
                Configuration,
                Fakes.Package,
                Fakes.PackageUrl,
