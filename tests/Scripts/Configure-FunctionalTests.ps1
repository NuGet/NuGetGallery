...
else
{
    ...
    Try
    {
        ...
        $SearchServiceUrl = ($slotResource.Properties.uri).Replace("http", "https")
    }
...
Write-Host "Using the following SearchServiceUrl: " $SearchServiceUrl
$env:SearchServiceUrl = $SearchServiceUrl
