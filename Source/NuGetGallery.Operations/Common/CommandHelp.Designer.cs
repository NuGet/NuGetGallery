...
namespace NuGetGallery.Operations.Common {
    ...
    internal class CommandHelp {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The &apos;{0}&apos; option is required. It must be specified either on the command line or it will be automatically provided in the NuGet Operations Console.
        /// </summary>
