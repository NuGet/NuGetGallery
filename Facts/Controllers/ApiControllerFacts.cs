    ...
    public class ApiControllerFacts
    {
        ...
        public class TheGetPackageAction
        {
            ...
            public void GetPackageReturnsCacheablePackageIfAllowCacheIsTrue()
            {
                ...
                httpCache.Setup(hc => hc.SetETag(packageHash));
                httpCache.Setup(hc => hc.SetCacheability(HttpCacheability.Public));
                httpCache.Setup(hc => hc.SetProxyMaxAge(new TimeSpan(0, 0, 0, Constants.CacheExpirationInSeconds)));
