    ...
    public partial class V2FeedTest : GalleryTestBase
    {
        ...
        public void PackageFeedSortingTest()
        {
            ...
            for (int i = 1; i < 10; i++)
            {
                ...
                Assert.IsTrue(responseText.IndexOf(">" + packageName[i - 1] + "<") < responseText.IndexOf(">" + packageName[i] + "<"), "Expected string " + packageName[i - 1] + " to come before " + packageName[i] + ".");
            }
        }
        ...
        public void PackageFeedCountParameterTest()
        {
            ...
            int packageCount = responseText.Split("{".ToCharArray()).Length - 1;
            Assert.IsTrue(packageCount == 500, "Expected feed to contain 500 packages.");
            ...
            packageCount = responseText.Split("{".ToCharArray()).Length - 1;
            Assert.IsTrue(packageCount == 5, "Expected feed to contain 5 packages.");
        }
    }
}
